...
namespace CovidApi.Data.Seeders
{
        ...
        where TIdentityRole : IdentityRole, new()
    {
        ...
        private const string DefaultAdminUserName = "CodeLifterIO";
        private const string DefaultAdminUserEmail = "a@CodeLifter.net";
        private const string DefaultAdminUserPassword = "Ch@ngeMe1";
        ...
        private static async Task<TIdentityUser> CreateDefaultAdminUser(UserManager<TIdentityUser> userManager)
        {
            ...
            if (user == null)
            {
                ...
                {
                    throw new ApplicationException($"Could not create '{DefaultAdminUserName}' user");
                }
            }
        ...
        {
            var context = services.GetRequiredService<CovidContext>();
