...
{
    public partial class InitAndIdent : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Confirmed = table.Column<int>(type: "integer", nullable: true),
                    ...
                    IncidenceRate = table.Column<double>(type: "double precision", nullable: true),
                    ...
                    CombinedKey = table.Column<string>(type: "text", nullable: true),
                    CountrySlugId = table.Column<string>(type: "text", nullable: true),
                    ProvinceSlugId = table.Column<string>(type: "text", nullable: true),
                    DistrictSlugId = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartFileName = table.Column<string>(type: "text", nullable: true),
                    LastCompletedFileName = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    GeoCoordinateId = table.Column<int>(type: "integer", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    FIPS = table.Column<string>(type: "text", nullable: true),
                    GeoCoordinateId = table.Column<int>(type: "integer", nullable: true),
                    ProvinceSlugId = table.Column<string>(type: "text", nullable: true),
                    CountrySlugId = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Totals_SourceFile_CountrySlugId_ProvinceSlugId_DistrictSlug~",
                table: "Totals",
